...
const ProductBySubCat = ({ addToCart,addToCompare }) => {
  const { id } = useParams();
  ...
  useEffect(() => {
    axios.get(`http://localhost:8000/api/products`)
      .then((res) => {
        ...
        const filteredData = items.filter((result) => result.subcategories === id);
                  ...
                  <div className="p-4 h-[140px]">
                    ...
                    {/* <div className="mt-3">
                      <button
                        ...
                        className="bg-blue-500 hover:bg-blue-700 text-white rounded px-4 py-2 mr-2"
                      >
                        Add to Cart
                      </button>
